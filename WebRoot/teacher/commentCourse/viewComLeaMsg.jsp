		...
		<center><br/>
			...
			<table class="table table-striped table-bordered table-hover table-condensed">
				...
				<%
					...
					String sql = "select comCouNum,commentCouInfo.couNum,couName,couTime,comLeaMsg from courseInfo inner join commentCouInfo on courseInfo.couNum = commentCouInfo.couNum where couTerm="+couTerm+" and teaNum="+accountNum+" and comCouNum not in (select comCouNum from commentCouInfo where comLeaMsg is null)";					
