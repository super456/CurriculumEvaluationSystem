...
<jsp:useBean id="couClassBean" class="admin.bean.CouClassStuInfo"/>
<jsp:useBean id="sqlBean" class="admin.bean.CouClassStuSqlBean" />
<%
  ...
  <td>操作</td>
			...
			<%
				...
				for (java.util.Iterator it = list.iterator(); it.hasNext();) {
					couClassBean = (admin.bean.CouClassStuInfo) it.next();
			%>
			<tr>
				...
				<a href="searchByStuNum?stuNum=<%=couClassBean.getStuNum() %>&tableName=admin/searchStuInfo.jsp">学生信息</a>
				</td>
			</tr>
			<%
				}
