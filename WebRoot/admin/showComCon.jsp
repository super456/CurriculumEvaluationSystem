...
<jsp:useBean id="comConBean" class="admin.bean.CommentContent" />
<jsp:useBean id="sqlBean" class="admin.bean.ComConSqlBean" />
<%
		...
		<table border=1 bgcolor="#ffffff" width=120%>
			...
			<%
				...
				for (java.util.Iterator it = list.iterator();it.hasNext();) {
					comConBean = (admin.bean.CommentContent)it.next();
			 %>
			<tr>
