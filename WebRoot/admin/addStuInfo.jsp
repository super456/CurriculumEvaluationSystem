...
<div class="wrapper">
  ...
  <tr><td>学生编号: </td>  
  <td><input type="text" name="stuNum" size=10/></td></tr>
  <tr><td>姓名:</td>       
  <td><input type="text" name="stuName" size=10 /></td></tr>
  <tr><td>性别:</td>
  ...
  <tr><td>年级:</td>       
  <td><input type="text" name="stuGrade" size=10 /></td></tr> 
  <tr><td>院系专业及班级:</td>       
  <td><input type="text" name="stuForm" size=25 /></td></tr>
  <tr><td>联系电话:</td>       
  <td><input type="text" name="stuPhone" size=12 /></td></tr>
  <tr><td>备注:</td>
